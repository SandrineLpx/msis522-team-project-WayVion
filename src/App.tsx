    ...
    <>
      ...
      <nav className="sticky-nav" aria-label="Page sections">
        <div className="sticky-nav-inner">
          <img src={`${base}project-assets/wayvion-logo.png`} alt="WayVion" className="nav-logo" />
          <div className="nav-links">
            <a href="#hero">Overview</a>
            <a href="#try-live">Live Demo</a>
            <a href="#team">Team</a>
      ...
      <div className="page-shell">
        <div id="main-content" className="page-container">
          <section id="hero" className="hero surface hero-surface hero-two-col reveal">
          ...
          <section id="try-live" className="try-live-section reveal">
            <div className="try-live-header">
              ...
              <a
                ...
                aria-label="Open WayVion in new tab"
              >
            ...
            <div className="browser-chrome">
              ...
              <div className="iframe-wrap">
                {!iframeLoaded && (
                  <div className="iframe-loader" aria-label="Loading app">
                    <div className="iframe-spinner" />
                    <p className="iframe-loader-text">Loading WayVion…</p>
                  </div>
                )}
                <iframe
          ...
          <section id="team" className="reveal">
            <SectionHeader eyebrow="Team" title="Founding Team" description="" />
          ...
          <section id="problem" className="two-col-grid reveal">
          ...
          <section id="how-to-use" className="surface instructions-surface reveal">
          ...
          <section id="features" className="reveal">
            <SectionHeader eyebrow="Product" title="WayVion's Features Highlight" description="" />
            <div className="card-grid two-up">
              {projectData.features.map((feature) => (
                <div key={feature.title} className="surface padded-card feature-card-with-image">
                  {feature.assetPath && (
                    <div
                      className="feature-image-wrap clickable-image"
                      onClick={() => openLightbox(`${base}${feature.assetPath!.replace(/^\//, '')}`, feature.title)}
                      role="button"
                      tabIndex={0}
                      aria-label={`View ${feature.title} full size`}
                      onKeyDown={(e) => e.key === 'Enter' && openLightbox(`${base}${feature.assetPath!.replace(/^\//, '')}`, feature.title)}
                    >
          ...
          <section id="stack" className="two-col-grid reveal">
            <div className="surface padded-card">
              <div className="card-heading">
              ...
              {projectData.gallery.map((item) =>
                item.assetPath ? (
                  <div key={item.title} className="surface gallery-card">
                    <div
                      className="gallery-image-wrap clickable-image"
                      onClick={() => openLightbox(`${base}${item.assetPath!.replace(/^\//, '')}`, item.title)}
                      role="button"
                      tabIndex={0}
                      aria-label={`View ${item.title} full size`}
                      onKeyDown={(e) => e.key === 'Enter' && openLightbox(`${base}${item.assetPath!.replace(/^\//, '')}`, item.title)}
                    >
          ...
          <section className="closing-card reveal">
            <div className="closing-left">
              ...
              <p>
                Unlike ChatGPT or Claude, WayVion does not just answer questions — it builds a structured, sequenced
                learning path with real verified resources, adapts in real time based on your performance, and remembers
                where you left off. Unlike online learning platforms like Coursera or Udemy, WayVion is not locked to a
                fixed library or pre-defined syllabus — it covers any topic, budgets time to your schedule, and
                restructures your roadmap when you struggle.
              </p>
          ...
          <section className="reveal">
            <div className="card-grid two-up">
              <div className="surface gallery-card">
                <div
                  className="gallery-image-wrap clickable-image"
                  onClick={() => openLightbox(`${base}project-assets/creative-product-award.jpg`, 'WayVion wins Creative Product Award at Gen AI Demo Day')}
                  role="button"
                  tabIndex={0}
                  aria-label="View award photo full size"
                  onKeyDown={(e) => e.key === 'Enter' && openLightbox(`${base}project-assets/creative-product-award.jpg`, 'WayVion wins Creative Product Award at Gen AI Demo Day')}
                >
                  <img
                    src={`${base}project-assets/creative-product-award.jpg`}
                    alt="WayVion wins Creative Product Award at Gen AI Demo Day"
              ...
              <div className="surface gallery-card">
                <div
                  className="gallery-image-wrap clickable-image"
                  onClick={() => openLightbox(`${base}project-assets/team-photo.jpg`, 'WayVion team at Gen AI Demo Day')}
                  role="button"
                  tabIndex={0}
                  aria-label="View team photo full size"
                  onKeyDown={(e) => e.key === 'Enter' && openLightbox(`${base}project-assets/team-photo.jpg`, 'WayVion team at Gen AI Demo Day')}
                >
                  <img
                    src={`${base}project-assets/team-photo.jpg`}
                    alt="WayVion team at Gen AI Demo Day — Nathan Fitzgerald, Swati Choudhury, Professor Leonard Boussioux, and Sandrine Lepesqueux"
                    className="gallery-image"
                  />
                </div>
                <div className="gallery-body">
      ...
      {lightboxSrc && (
        ...
        >
          <button type="button" className="lightbox-close" onClick={() => setLightboxSrc(null)} aria-label="Close image preview">
            <X size={20} />
          </button>
          <img
            src={lightboxSrc}
